...
var Switch = function (_a) {
    ...
    return (jsxRuntime.jsxs("label", __assign({ className: classnames(styles$8._wrapper, (_b = {},
            _b[className] = className,
            _b)), style: style }, { children: [jsxRuntime.jsx("input", { type: "checkbox", className: styles$8._content, disabled: disabled, checked: isChecked, onChange: onCheckBoxChange }), jsxRuntime.jsx("span", { className: classnames(styles$8._slider, (_c = {},
...
var TextArea = function (_a) {
    ...
    return (jsxRuntime.jsx("textarea", { placeholder: placeholder, value: textAreaValue, onChange: onTextAreaChange, disabled: disabled, readOnly: readOnly, className: classnames(styles$7._content, (_b = {},
...
var Button = function (_a) {
    ...
    return (jsxRuntime.jsx("div", __assign({ className: classnames(styles$6._wrapper, (_b = {},
            ...
            _b[className] = className,
            _b)) }, { children: jsxRuntime.jsx("button", __assign({ className: styles$6._wrapper_in, disabled: disabled, onClick: function () {
                if (!disabled) {
                    onClick();
                }
            } }, { children: jsxRuntime.jsxs("div", __assign({ className: styles$6._content }, { children: [before ? jsxRuntime.jsx("div", __assign({ className: styles$6._before }, { children: before })) : null, children ? (jsxRuntime.jsx(Text, __assign({ size: 12, lineHeight: "14px", className: styles$6._content_in }, { children: children }))) : null, after ? jsxRuntime.jsx("div", __assign({ className: styles$6._after }, { children: after })) : null] })) })) })));
};
...
var Group = function (_a) {
    ...
    return (jsxRuntime.jsx("div", __assign({ className: classnames(styles$5.__wrapper, (_b = {},
            _b[className] = className,
...
var Avatar = function (_a) {
    ...
    return (jsxRuntime.jsxs("div", __assign({ className: classnames(styles$4.__wrapper, (_b = {},
            _b[styles$4.__load_error] = isAvatarLoadError,
            _b[className] = className,
            _b)), style: {
            width: size,
            height: size,
        } }, { children: [!isAvatarLoadError ? (jsxRuntime.jsx("img", { onError: onAvatarLoadFailed, src: src, alt: alt, className: styles$4.__content })) : null, isAvatarLoadError ? (jsxRuntime.jsx(Text, __assign({ color: "var(--color_avatar_fallback)", size: 14, lineHeight: "14px", weight: "600", className: styles$4.__fallback_content }, { children: fallbackName }))) : null] })));
};
...
var Cell = function (_a) {
    ...
    return (jsxRuntime.jsx("div", __assign({ className: classnames(styles$3._wrapper, (_b = {},
        ...
        } }, { children: jsxRuntime.jsxs("div", __assign({ className: styles$3._wrapper_in }, { children: [beforeIcon ? (jsxRuntime.jsx("div", __assign({ className: styles$3._before_icon }, { children: beforeIcon }))) : null, before ? jsxRuntime.jsx("div", __assign({ className: styles$3._before }, { children: before })) : null, children || description ? (jsxRuntime.jsxs("div", __assign({ className: styles$3._content }, { children: [children ? (jsxRuntime.jsx(Text, __assign({ className: styles$3._content_in, size: 12, lineHeight: "14px" }, { children: children }))) : null, description ? (jsxRuntime.jsx(Text, __assign({ className: styles$3._content_description, size: 12, lineHeight: "14px" }, { children: description }))) : null] }))) : null, indicator ? (jsxRuntime.jsx(Text, __assign({ className: styles$3._indicator, size: 12, lineHeight: "14px" }, { children: indicator }))) : null, after ? (jsxRuntime.jsx(Text, __assign({ className: styles$3._after, size: 12, lineHeight: "14px" }, { children: after }))) : null, afterIcon ? (jsxRuntime.jsx("div", __assign({ className: styles$3._after_icon }, { children: afterIcon }))) : null] })) })));
};
...
var BlockHeader = function (_a) {
    ...
    return (jsxRuntime.jsxs("div", __assign({ className: classnames(styles$2._wrapper, (_b = {},
            _b[className] = className,
            _b)) }, { children: [children ? (jsxRuntime.jsx(Text, __assign({ className: styles$2._content, size: 12, lineHeight: "14px" }, { children: children }))) : null, after ? (jsxRuntime.jsx(Text, __assign({ className: styles$2._after, size: 12, lineHeight: "14px" }, { children: after }))) : null] })));
};
...
var Separator = function (_a) {
    ...
    return (jsxRuntime.jsx("div", __assign({ className: classnames(styles._wrapper, (_b = {},
            _b[className] = className,
            _b)) }, { children: jsxRuntime.jsx("div", { className: styles._wrapper_in }) })));
};
